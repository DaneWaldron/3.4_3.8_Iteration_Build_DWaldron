...
<body>
    ...
    <main>
        ...
        <div class="buttons">
            <button type="button" class="button"><a href="adduser.php">Add User</a></button>
            <button type="button" class="button"><a href="deleteuser.php">Delete User</a></button>
			<button type="button" class="button"><a href="updatepw.php">Update User Password</a></button>
        </div>
    </main>
